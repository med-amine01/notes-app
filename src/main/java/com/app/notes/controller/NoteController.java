...
public class NoteController {
    ...
    @PostMapping
    @Operation(summary = "Create a new note", description = "Creates a new note with the provided title and content")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "201",
    ...
    public ResponseEntity<NoteResponse> createNote(
            @Parameter(description = "Note request containing title and content", required = true) @Valid @RequestBody
    ...
    public ResponseEntity<Void> deleteNote(@Parameter(description = "Note ID", required = true) @PathVariable Long id) {
